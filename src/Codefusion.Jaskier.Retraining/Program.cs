...
namespace CallBatchExecutionService
{
    ...
    class Program
    {
        ...
        static async Task OverwriteModel(string baseLocation, string relativeLocation, string sasBlobToken, string apiKey, string endpointUrl)
        {
            var resourceLocations = new
            {
                Resources = new[]
                {
                    new
                    {
                        Name = "BAS Defect Prediction [trained model]",
        ...
        static async Task InvokeBatchExecutionService()
        {
            ...
            const string BaseUrl = "https://ussouthcentral.services.azureml.net/workspaces/service/jobs";

            const string StorageAccountName = "account"; // Replace this with your Azure Storage Account name
            const string StorageAccountKey = "accountKey"; // Replace this with your Azure Storage Key
            const string StorageContainerName = "container"; // Replace this with your Azure Storage Container name
            ...
            UploadFileToBlob(@"c:\Temp\cdp.csv" /*Replace this with the location of your input file*/,
                ...
                while (!done)
                {
                    ...
                    switch (status.StatusCode)
                    {
                        ...
                        case BatchScoreStatusCode.Finished:
                            ...
                            // TODO Check output1 results
                            
                            OverwriteModel(status.Results["output2"].BaseLocation, 
                                status.Results["output2"].RelativeLocation, 
                                status.Results["output2"].SasBlobToken,
                                "", 
                                "https://management.azureml.net/workspaces/service/endpoints/new").Wait();
                            break;
                    }
